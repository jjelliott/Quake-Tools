...
// initialize the scroll view
	...
	[zscrollview_i setAutosizing: NS_WIDTHSIZABLE | NS_HEIGHTSIZABLE];
	...
	callback: (void (*) (float dy)) callback
{
	...
	while (1)
	{
		event = [NSApp getNextEvent: 
			NS_LMOUSEUPMASK | NS_LMOUSEDRAGGEDMASK
			| NS_RMOUSEUPMASK | NS_RMOUSEDRAGGEDMASK];
